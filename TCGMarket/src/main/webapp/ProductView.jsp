...
<body>
	...
	<div class="container">
		<a href="product">Lista</a> <a href="cart.jsp">Visualizza Carrello</a>
	</div>
	...
	<div class=catalogo>
		<form style="text-align: center;" action="product" method="post">
			...
			<label for="nome">Nome:</label><br> <input class=catalogo
				name="nome" type="text" maxlength="100" required
			...
			<label for="data">Data di uscita</label><br> <input
				...
				for="quant">Quantita':</label><br> <input class=catalogo
				name="quant" type="number" min="1" value="1" required><br>

			<input class=btn type="submit" value="Aggiungi"><input
				class=btn type="reset" value="Ripristina">
		</form>
	</div>


	<div class=wrapper>
		<form class=cart action="OrderHistory.jsp" method="get"
			id="orderhistory">
